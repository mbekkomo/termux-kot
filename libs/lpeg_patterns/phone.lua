...
optional_parens((P("0")) ^ -1 * S("2378"))
        ...
        * digit
    -- Mobile numbers
    + (optional_parens(P("0") * S("45") * digit * digit) + S("45") * digit * digit) * seperator ^ -1 * digit * digit * digit * seperator ^ -1 * digit * digit * digit
    -- Local rate calls
...
local international = (
    ...
    + (
        ...
        * (seperator ^ -1 * digit) ^ 6 -- At least 6 digits
)
